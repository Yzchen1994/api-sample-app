...
import com.reimaginebanking.api.nessieandroidsdk.requestclients.AtmClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.BillClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.BranchClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.CustomerClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.DepositClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.EnterpriseClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.MerchantClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.PurchaseClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.TransferClient;
import com.reimaginebanking.api.nessieandroidsdk.requestclients.WithdrawalClient;
 ...
 */
public class NessieClientWithLog {
    ...
    private static NessieClientWithLog INSTANCE;
    ...
    private NessieClientWithLog(String key, RestAdapter ra) {
        this.key = key;
    ...
    public static NessieClientWithLog getInstance(String key) {
        if (INSTANCE == null) {
            INSTANCE = new NessieClientWithLog(key, null);
        }

        return INSTANCE;
    }

    public static NessieClientWithLog getInstance(String key, RestAdapter ra) {
        if (INSTANCE == null) {
            INSTANCE = new NessieClientWithLog(key, ra);
        }
